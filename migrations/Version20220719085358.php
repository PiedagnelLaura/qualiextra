 ...
 */
final class Version20220719085358 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, packages_id INT DEFAULT NULL, date DATETIME DEFAULT NULL, status INT NOT NULL, INDEX IDX_CBE5A331CA871E03 (packages_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
