 ...
 */
final class Version20220720072305 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE establishment ADD style_id INT NOT NULL, DROP style');
        $this->addSql('ALTER TABLE establishment ADD CONSTRAINT FK_DBEFB1EEBACD6074 FOREIGN KEY (style_id) REFERENCES style (id)');
        $this->addSql('CREATE INDEX IDX_DBEFB1EEBACD6074 ON establishment (style_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_DBEFB1EEBACD6074 ON establishment');
        $this->addSql('ALTER TABLE establishment ADD style VARCHAR(100) NOT NULL, DROP style_id');
    }
}